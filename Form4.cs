...
namespace Assignment
{
    public partial class Form4 : Form
    {
        ...
        //declaring the french list
        static List<string> frenchList = new List<string>() { "rouge", "orange", "jaune", "vert", "bleu", "violet", "marron", "sombre", "gris", "pâle", "indigo", "rose", "bleu clair", "bleu foncé", "bleu profond"};
        ...
        //variable to let the user chose how many questions to be asked
        static int size;
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //for loop using the size as a parameter to store random colours in the colour variable
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
...

                {
                    ...
                    if (colour == englishList[count] && answer == frenchList[count])
                    {
                        //output message
                    ...
                    else if (colour == englishList[count] && answer != frenchList[count])
                    {
        ...
        //method that gets called out when i want to clear and focus textbox 1
        private void clear()
        {
            textBox1.Clear();
            textBox1.Focus(); 
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
...

            {
                ...
                {
                    MessageBox.Show("Answer: " + frenchList[count]);
                }
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
...

            {
                ...
                if (colour == englishList[count])
                {
                    MessageBox.Show("First Letter: " + frenchList[count].Substring(0, 1));

                    //if a hint us used, 5 points is deducted from the player
                    points = points - 5;
                }
